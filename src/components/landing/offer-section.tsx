  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto px-4">
        ...
        >
          <h2 className="text-lg sm:text-xl text-white mb-3 font-semibold">
            الزراعة شامل الطيران والفندق
          </h2>
          <div className="flex items-baseline justify-center gap-2">
            <span className="text-5xl sm:text-6xl font-black" style={{ color: "#D8B676" }}>
              5,980
            </span>
            <span className="text-2xl font-bold" style={{ color: "#D8B676" }}>
              ريال
            </span>
          </div>
        </div>
        ...
        <h3 className="text-2xl font-black text-center mb-8" style={{ color: "#D8B676" }}>
          العرض يشمل
        </h3>
        ...
        <div className="grid grid-cols-2 gap-4 mb-12">
          {offerIncludes.map((item, i) => (
            ...
            >
              <div className="mb-3" style={{ color: "#D8B676" }}>
                <OfferIcon icon={item.icon} className="w-8 h-8" />
              </div>
        ...
        <a
          ...
          className="flex items-center justify-center gap-3 w-full px-8 py-4 rounded-2xl font-bold text-lg transition-transform hover:scale-[1.03] text-black"
          style={{
