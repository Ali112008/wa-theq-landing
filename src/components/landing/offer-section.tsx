    ...
    >
      <div className="max-w-md mx-auto px-4">
        ...
        <div className="flex items-baseline justify-center gap-1.5 mb-4">
          ...
          <span className="text-lg font-bold" style={{ color: "#D8B676" }}>
            ريال
          </span>
        </div>
        ...
        <a
          ...
          className="flex items-center justify-center gap-2.5 w-full px-6 py-3 rounded-xl font-bold text-sm transition-transform hover:scale-[1.03] text-black"
          style={{
            background: "linear-gradient(to left, #C99A58, #D8B676)",
            boxShadow: "0 4px 15px rgba(216, 182, 118, 0.3)",
          }}
