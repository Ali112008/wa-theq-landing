    ...
    >
      <div className="max-w-2xl mx-auto px-4">
        ...
        <h2 className="text-lg sm:text-xl font-black text-center text-white mb-4 leading-relaxed">
          ...
          <br />
          <span style={{ color: "#D8B676" }} className="text-3xl sm:text-4xl">بـ 5,980 ريال</span>
        </h2>
        ...
        >
          <h3 className="font-bold mb-3 text-center" style={{ color: "#D8B676" }}>
            العرض يشمل:
          </h3>
          ...
          <ul className="space-y-2 mb-4">
            {offerIncludes.map((item, i) => (
              <li key={i} className="flex items-center gap-2 text-white text-sm sm:text-base">
                ...
                >
                  <CheckIcon className="w-3 h-3" style={{ color: "#D8B676" }} />
                </span>
                <span>{item}</span>
              </li>
            ))}
