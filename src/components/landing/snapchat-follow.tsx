    ...
    >
      <div className="max-w-xl mx-auto px-4 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-gold hover:bg-gold-light text-black font-bold px-8 py-4 rounded-full text-base sm:text-lg transition-transform hover:scale-105 shadow-lg"
