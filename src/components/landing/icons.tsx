 ...
 * Using inline SVG for zero network requests and instant rendering.
 */
...
export function NoPainIcon({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function DhiIcon({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
