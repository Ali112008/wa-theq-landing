...
const images = [
  { src: "/images/gallery/new-2.webp", alt: "نتيجة زراعة الشعر - حالة 2" },
  { src: "/images/gallery/new-1.webp", alt: "نتيجة زراعة الشعر - حالة 1" },
  { src: "/images/gallery/new-3.webp", alt: "نتيجة زراعة الشعر - حالة 3" },
  { src: "/images/gallery/new-4.webp", alt: "نتيجة زراعة الشعر - حالة 4" },
  { src: "/images/gallery/new-5.webp", alt: "نتيجة زراعة الشعر - حالة 5" },
  { src: "/images/gallery/new-6.webp", alt: "نتيجة زراعة الشعر - حالة 6" },
  { src: "/images/gallery/new-7.webp", alt: "نتيجة زراعة الشعر - حالة 7" },
  { src: "/images/gallery/new-8.webp", alt: "نتيجة زراعة الشعر - حالة 8" },
  { src: "/images/gallery/new-9.webp", alt: "نتيجة زراعة الشعر - حالة 9" },
  { src: "/images/gallery/new-10.webp", alt: "نتيجة زراعة الشعر - حالة 10" },
];
