...
const GOLD_GRADIENT = "linear-gradient(to left, #B09B90, #C9B7AE)";
const GOLD_GRADIENT_HOVER = "linear-gradient(to left, #C9B7AE, #D5C1B8)";
...
interface WhatsAppButtonProps {
  ...
  message?: "default" | "consultation" | "offer";
  showIcon?: boolean;
}
