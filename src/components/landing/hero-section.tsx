...
export function HeroSection() {
  return (
    ...
    >
      ...
      {/* شريط علوي sticky - اللوجو + زر سناب + زر واتساب واضح */}
      <div
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="inline-flex items-center justify-center w-9 h-9 bg-gold hover:opacity-80 text-black rounded-full transition-opacity"
          ...
          {/* زر واتساب واضح في الأعلى */}
          <a
            href="https://wa.me/966532424669?text=السلام%20عليكم،%20أريد%20تقييم%20حالتي%20مجاناً"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full font-bold text-xs sm:text-sm text-black transition-transform hover:scale-105"
            style={{
